...
#        y = self.final_layer(x[0])
        a ,b = self.srpose_head(x)
        return a,b
...
#     #     torch.load('pose_hrnet_w48_384x288.pth')
#     #     #torch.load('pose_hrnet_w32_256x192.pth')
#     # )
#     # print('ok!!')
...
#     y = model(torch.ones(1, 3, 1024, 1024).to(device))
#
#     print(y.shape)
